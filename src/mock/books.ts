...
export const books: Card[] = [
  {
    ...
    published: new Date('10-19-1953').toLocaleDateString('en-US', {
      year: 'numeric',
      month: 'short',
      day: 'numeric',
    }),
  ...
  },
  {
    ...
    published: new Date('11-10-1961').toLocaleDateString('en-US', {
      year: 'numeric',
      month: 'short',
      day: 'numeric',
    }),
  ...
  },
  {
    ...
    published: new Date('08-01-1965').toLocaleDateString('en-US', {
      year: 'numeric',
      month: 'short',
      day: 'numeric',
    }),
  ...
  },
  {
    ...
    published: new Date('01-01-1946').toLocaleDateString('en-US', {
      year: 'numeric',
      month: 'short',
      day: 'numeric',
    }),
